...
(test "symbolo-24-b"
  (run* (q)
    (fresh (w x y z)
      ...
      (symbolo z)
      (== `(,w ,x ,y ,z) q)))
  '(#s(Ans ((_.0 _.1 _.2 _.3)) ((=/= ((_.0 _.2) (_.1 _.3))) (sym _.0) (sym _.3)))))
...
(test "symbolo-24-c"
  (run* (q)
    (fresh (w x y z)
      ...
      (symbolo y)
      (== `(,w ,x ,y ,z) q)))
  '(#s(Ans ((_.0 _.1 _.2 _.3)) ((=/= ((_.0 _.2) (_.1 _.3))) (sym _.0) (sym _.2)))))
...
(test "symbolo-24-d"
  (run* (q)
    (fresh (w x y z)
      ...
      (== w y)
      (== `(,w ,x ,y ,z) q)))
  '(#s(Ans ((_.0 _.1 _.0 _.2)) ((=/= ((_.1 _.2))) (sym _.0)))))
...
(test "symbolo-30"
  (run* (q)
    (fresh (w x)
      ...
      (=/= `(z . ,x) `(,w . 6))
      (== `(,w ,x) q)))
  '(#s(Ans ((_.0 _.1)) ((=/= ((_.0 z) (_.1 6))) (sym _.0)))))
