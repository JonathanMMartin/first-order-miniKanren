...
(test "stringo-24-c"
  (run* (q)
    (fresh (w x y z)
      ...
      (stringo y)
      (== `(,w ,x ,y ,z) q)))
  '(#s(Ans ((_.0 _.1 _.2 _.3)) ((=/= ((_.0 _.2) (_.1 _.3))) (str _.0) (str _.2)))))
...
(test "stringo-24-d"
  (run* (q)
    (fresh (w x y z)
      ...
      (== w y)
      (== `(,w ,x ,y ,z) q)))
  '(#s(Ans ((_.0 _.1 _.0 _.2)) ((=/= ((_.1 _.2))) (str _.0)))))
...
(test "stringo-30"
  (run* (q)
    (fresh (w x)
      ...
      (=/= `("z" . ,x) `(,w . 6))
      (== `(,w ,x) q)))
  '(#s(Ans ((_.0 _.1)) ((=/= ((_.0 "z") (_.1 6))) (str _.0)))))
