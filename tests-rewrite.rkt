...
(test 'conj-term-sub-0
  (normalize-goal (conj (=/= c d) (conj (== c 1) (== d 2))))
  #s(conj #s(== 1 #s(var c 12)) #s(== 2 #s(var d 13))))

(test 'conj-term-sub-1
  (normalize-goal (disj (conj (=/= a b) (conj (== c 1) (== d 2))) (conj (=/= c d) (conj (== c 1) (== d 2)))))
  #s(conj #s(== 1 #s(var c 12)) #s(== 2 #s(var d 13))))